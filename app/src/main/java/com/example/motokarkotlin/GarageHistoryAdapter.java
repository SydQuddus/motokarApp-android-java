...
public class GarageHistoryAdapter extends RecyclerView.Adapter<GarageHistoryAdapter.ViewHolder> {
    ...
    GarageHistoryAdapter(Context context, List<String> vNameData) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.listhistory, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(mContext, ActivityHistoryGarage.class);
