...
public class UploadVLicense extends AppCompatActivity {

    RegistrationCache cacheObj;

    DatabaseReference databaseAccount;

    StorageReference vLicenseref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_vlicense);

        //Set Database and storage
        vLicenseref = FirebaseStorage.getInstance().getReference("vLicense");
        ...
        databaseAccount.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Picasso.get().load(dataSnapshot.child("vehLicense").getValue().toString()).into(img);
            }
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(uploadTask != null && uploadTask.isInProgress()) {
                    Toast.makeText(UploadVLicense.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
                    fileuploader();
                }
            }
    ...
    {
        final StorageReference Ref = vLicenseref.child(System.currentTimeMillis()+"."+getExtension(imguri));
        ...
        uploadTask = Ref.putFile(imguri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        //final toast
                        Toast.makeText(UploadVLicense.this, "Vehicle license uploaded successfully", Toast.LENGTH_SHORT).show();
                    }
                })
